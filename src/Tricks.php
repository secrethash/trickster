...
class Tricks extends Controller
{
     ...
     * @var string
     */
    private $_twitterUrl  = config('trickster.apiUrl.twitter.social');

    /**
     * Facebook api url for get likes
     * @var string
     */
    private $_facebookUrl = config('trickster.apiUrl.facebook.social');

    /**
     * Google api key from short urls
     * @var null
     */
    private $_googleApiKey = config('trickster.api.google.urlShorten');

    /**
     * Google api url for shorting urls
     * @var string
     */
    private $_googleShortApiUrl = config('trickster.apiUrl.google.urlShorten');

    /**
     * TinyURL api url for shorting urls
     * @var string
     */
    private $_tinyUrlShortApiUrl = config('trickster.apiUrl.tinyurl.urlShorten');

    /**
     * Allowable tags for clean function
     * @var string
     */
    private $_allowableTags = config('trickster.ts_aTags');

    /**
     * Wikipedia url for api
     * @var string
     */
    private $_wikiApiUrl = config('trickster.apiUrl.wikipedia.askWiki');

    /**
     * Google url for suggest keywords
     * @var string
     */
    private $_googleSuggestApiUrl = config('trickster.apiUrl.google.suggest');

    /**
     * Get youtube video data from api
     * @var string
     */
    private $_youtubeVideoApi = config('trickster.apiUrl.google.youtube');

    /**
     * Get vimeo video data from api
     * @var string
     */
    private $_vimeoVideoApi = config('trickster.apiUrl.vimeo.vimeo');
     ...
     */
    public function truncate($text, $number, $suffix = ' read more...')
    {
